@ProductsSearchDetailsCtrl = ($scope, $state, $stateParams, $http, productData, ordersData) ->
...
@ProductsSearchDetailsCtrl.$inject = ['$scope', '$state', '$stateParams', '$http', 'productData', 'ordersData']
